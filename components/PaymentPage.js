            ...
            <div className="makePayment md:w-1/2 w-full bg-slate-900 text-white rounded-lg p-10">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  // }
                  type="button"
                  className="text-white bg-linear-to-br from-purple-700 to-blue-600 hover:bg-linear-to-bl focus:ring-4 focus:outline-hidden focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mt-0.5 mr-0"
                >
                  Pay
                </button>
              </div>
